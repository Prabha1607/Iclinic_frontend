...
function ic(err?: string) {
  return `w-full px-4 py-2.5 pr-10 rounded-xl border text-blue-900 placeholder-blue-300 focus:outline-none focus:ring-2 focus:border-transparent transition text-sm ${
    err
...
export default function Register() {
  ...
  const validate = (f = form): FieldErrors =>
    collectErrors({
      ...
      confirmPassword:
        rules.required(f.confirmPassword, 'Confirm password') ||
        rules.confirmPassword(f.confirmPassword, f.password),
    });
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-blue-100 p-8">
              <div className="mb-8">
                ...
                <p className="text-sm text-blue-400">
                  Join iClinic to manage appointments
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} noValidate className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="first_name" className={lbl}>
                  ...
                  <div>
                    <label htmlFor="last_name" className={lbl}>
                ...
                <div>
                  <label htmlFor="phone_no" className={lbl}>

...
export default function BookingPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setMessage({
        text: `Call initiated successfully. SID: ${res.call_sid}`,
        isError: false,
      });
      setPhone('');
    } catch (err: any) {
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="flex flex-col items-center mb-10">
            ...
            <p
              ...
              className="text-2xl font-bold text-[#0f1340] tracking-tight"
            >
              Voice Assistant
            </p>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-blue-100 overflow-hidden">
            ...
            <div className="p-6">
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  >
                    <div className="absolute inset-y-0 left-3.5 flex items-center pointer-events-none">
                      <svg
                        className={`w-4 h-4 transition-colors ${isFocused ? 'text-[#3b5bfc]' : 'text-slate-400'}`}
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
                ...
                {message && (
                  <div
                    className={`fade-in flex items-start gap-2.5 rounded-xl px-3.5 py-3 text-sm ${
                      message.isError

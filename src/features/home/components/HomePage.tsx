  ...
  return (
    ...
    >
      ...
      <section className="hero-gradient dot-grid-bg relative overflow-hidden">
        ...
        <div
          className="hero-blob w-96 h-96 bg-blue-400 top-[-80px] right-[-60px]"
          style={{ position: 'absolute' }}
        />
        <div
          className="hero-blob w-80 h-80 bg-indigo-300 bottom-[-40px] left-[-60px]"
          style={{ position: 'absolute' }}
        />
        ...
        <div className="relative max-w-6xl mx-auto px-6 py-10 md:py-16 flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="fade-up-delay-3 text-base md:text-lg text-slate-500 leading-relaxed mb-6 max-w-lg mx-auto md:mx-0">
              iClinic uses an AI voice agent to handle your appointment booking,
              cancellations, and reminders — so your team can focus on patient care.
            </p>
          ...
          <div className="flex-1 flex justify-center fade-up-delay-3">
            <div className="relative w-full max-w-sm">
              ...
              <div className="bg-white rounded-3xl shadow-2xl border border-blue-100 p-6 relative z-10">
                ...
                <p
                  className="text-center text-sm font-semibold text-[#0f1340] mb-1"
                  style={{ fontFamily: "'Syne', sans-serif" }}
                >
                  AI Voice Agent
                </p>
      ...
      <section className="py-14 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-10">
            <span className="inline-block text-xs font-semibold uppercase tracking-widest text-[#3b5bfc] mb-3">
              How It Works
            </span>
            <h2
              className="text-3xl md:text-4xl font-bold text-[#0f1340]"
              style={{ fontFamily: "'Syne', sans-serif" }}
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={item.step}
                className="card-lift bg-white rounded-2xl border border-blue-50 p-7 shadow-sm relative"
              >
                <div className="feature-icon-wrap" style={{ background: item.bg }}>
                  {item.icon}
                </div>
                <div
                  className="absolute top-5 right-6 text-5xl font-bold text-[#f0f4ff]"
                  style={{ fontFamily: "'Syne', sans-serif" }}
                >
                  {item.step}
                </div>
                <h3
                  className="text-lg font-bold text-[#0f1340] mb-2"
                  style={{ fontFamily: "'Syne', sans-serif" }}
                >
                  {item.title}
                </h3>
            ...
            {[
              {
                ...
                desc: 'AI understands natural language — patients speak freely, the agent handles the rest.',
              },
              {
                icon: '📱',
                title: 'SMS Confirmations',
                desc: 'Instant SMS reminders and confirmations sent automatically after booking.',
              },
              {
                icon: '🔄',
                title: 'Easy Rescheduling',
                desc: 'Patients can reschedule or cancel with a simple callback — no hold music.',
              },
              {
                icon: '🔒',
                title: 'Secure & Private',
                desc: 'HIPAA-conscious design. Patient data is encrypted and never shared.',
              },
              {
                icon: '📊',
                title: 'Clinic Dashboard',
                desc: 'Manage all appointments, view analytics, and track no-shows in one place.',
              },
              {
                icon: '🌐',
                title: 'Multilingual',
                desc: 'Voice agent supports multiple languages — serve every patient in your community.',
              },
            ].map((f) => (
              <div
                key={f.title}
                className="card-lift bg-white rounded-2xl border border-blue-50 p-6 shadow-sm"
              >
                <div className="text-3xl mb-4">{f.icon}</div>
                <h3
                  className="text-base font-bold text-[#0f1340] mb-2"
                  style={{ fontFamily: "'Syne', sans-serif" }}
                >
                  {f.title}
                </h3>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              {
                quote:
                  'We reduced no-shows by 40% in the first month. The AI agent handles everything — our receptionist now focuses on in-clinic patients.',
              ...
              {
                quote:
                  'Patients love how easy it is. They just call in, talk naturally, and the appointment is done. No app needed!',
                name: 'Ravi Menon',
              ...
              {
                quote:
                  'Setup took less than a day. The team was responsive and the voice quality is crystal clear. Highly recommended.',
                name: 'Dr. Anita Reddy',
      ...
      <section className="py-14 bg-gradient-to-r from-[#3b5bfc] to-[#5b7fff]">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-blue-100 text-base mb-8 leading-relaxed">
            Join hundreds of clinics using iClinic's AI voice agent to streamline
            appointments and delight patients.
          </p>
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
            ...
            <div className="flex gap-10 text-sm text-blue-200/70">
              <div className="space-y-2">
                <p className="font-semibold text-white text-xs uppercase tracking-widest mb-3">
                  Product
                </p>

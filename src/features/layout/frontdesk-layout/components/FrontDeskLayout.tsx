  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full">
      <div className="px-6 pt-6 pb-5 border-b border-blue-800/40">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-blue-300 text-[11px] font-medium mt-0.5 leading-none">
              Front Desk
            </p>
          </div>
        </div>
      ...
      <nav className="flex-1 px-4 py-3 space-y-1 overflow-y-auto">
        <p className="text-blue-400 text-[10px] font-semibold uppercase tracking-widest px-3 pb-2">
          Menu
        </p>
        {NAV_ITEMS.map((item) => (
          <NavLink

    ...
    <div className="bg-white rounded-2xl border border-blue-50 shadow-sm hover:shadow-md transition-shadow duration-200 overflow-hidden">
      <div
        className={`h-1 w-full ${
          appt.status === 'SCHEDULED'
            ? 'bg-gradient-to-r from-[#3b5bfc] to-[#7c9afc]'
      ...
      <div className="p-5">
        <div className="flex items-start justify-between gap-3 mb-4">
          <div>
            <p
              className="text-base font-bold text-[#0f1340]"
        ...
        {appt.reason_for_visit && (
          <div className="flex items-start gap-2">
            <span className="text-xs font-semibold text-[#0f1340] w-20 flex-shrink-0 pt-0.5">
              Reason
            </span>
        ...
        <div className="flex items-center justify-end mt-4 pt-3 border-t border-slate-100">
          {ch && (
            <span
              className={`text-[10px] font-semibold px-2 py-0.5 rounded-full border ${ch.color}`}
            >
              {ch.label} Booking
            </span>
          )}
      ...
      <main className="flex-1 max-w-6xl mx-auto w-full px-4 sm:px-6 py-8">
        <div className="mb-8">
          ...
          <p className="text-sm text-[#374151] mt-1">
            Track and review all your appointment history in one place.
          </p>
        </div>
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center">
            <div className="w-20 h-20 rounded-3xl bg-[#eef2ff] flex items-center justify-center text-4xl mb-5">
              📅
            </div>
            <p
              className="text-xl font-bold text-[#0f1340] mb-2"
              style={{ fontFamily: "'Syne', sans-serif" }}
            >
              {filter === 'ALL'
                ? 'No appointments yet'

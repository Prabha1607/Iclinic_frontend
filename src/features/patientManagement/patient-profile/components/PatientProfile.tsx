...
function ic(base: string, err?: string) {
  return `${base}${
    err ? " !border-red-400 !bg-red-50/40 focus:!ring-red-300 focus:!border-red-400" : ""
  }`;
}
  ...
  return (
    ...
    >
      <style>{`
        ...
        .sk { background: linear-gradient(90deg,#f0f4ff 25%,#e8eeff 50%,#f0f4ff 75%); background-size:200% 100%; animation:sh 1.4s infinite; }
          ...
          <div className="lg:col-span-2 space-y-5">
            <div className="bg-white rounded-3xl p-6 space-y-3 border border-blue-50 shadow-sm">
              {Array.from({ length: 5 }).map((_, i) => (
                <div key={i} className="sk h-9 rounded-xl" />
              ))}
            </div>
            <div className="bg-white rounded-3xl p-6 space-y-3 border border-blue-50 shadow-sm">
...
export default function PatientProfile() {
  ...
  const inputBase =
    "w-full px-4 py-2.5 text-sm rounded-xl border border-slate-200 bg-slate-50 " +
    "text-slate-700 placeholder-slate-300 focus:outline-none focus:ring-2 " +
    "focus:ring-[#3b5bfc]/20 focus:border-[#3b5bfc] focus:bg-white transition";
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (form.preferred_language)
        profileFields.preferred_language = form.preferred_language;
      if (Object.keys(profileFields).length > 0)
        payload.patient_profile = profileFields;
      ...
      >
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center">
            <div className="w-16 h-16 rounded-2xl bg-red-50 flex items-center justify-center text-3xl mb-4 mx-auto">
              ⚠️
            </div>
  ...
  const isProfileIncomplete =
    !p.patient_profile?.date_of_birth || !p.patient_profile?.gender;
  ...
  return (
    ...
    >
      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-4 sm:px-6 py-8 fade-up">
        <div className="mb-7">
          <p className="text-xs font-bold uppercase tracking-widest text-[#3b5bfc] mb-1">
            Account
          </p>
          <h1
          ...
          <div>
            <div className="bg-white rounded-3xl border border-blue-50 shadow-sm overflow-hidden sticky top-24">
              <div
                ...
                style={{ background: "linear-gradient(90deg, #3b5bfc, #7c9afc)" }}
              />
                ...
                <div className="bg-slate-50 rounded-2xl p-4 border border-slate-100 mb-4">
                  ...
                  <div className="w-full h-1.5 bg-slate-200 rounded-full overflow-hidden">
                    <div
                      ...
                      style={{
                        width: `${completion}%`,
                        background: "linear-gradient(90deg, #3b5bfc, #7c9afc)",
                      }}
                    />
                  </div>
                  {completion < 100 && (
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          onBlur={handleBlur}
                          className={ic(inputBase, fieldErrors.first_name)}
                          placeholder="John"
                        />
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={handleChange}
                          onBlur={handleBlur}
                          className={ic(inputBase, fieldErrors.last_name)}
                          placeholder="Doe"
                        />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        onBlur={handleBlur}
                        className={ic(inputBase, fieldErrors.email)}
                      ...
                      <div className="flex gap-2">
                        <div className="w-28">
                          <input
                            ...
                            onChange={handleChange}
                            onBlur={handleBlur}
                            className={ic(inputBase, fieldErrors.country_code)}
                            placeholder="+91"
                          />
                          <FieldMsg msg={fieldErrors.country_code} />
                        </div>
                        <div className="flex-1">
                          <input
                            ...
                            onChange={handleChange}
                            onBlur={handleBlur}
                            className={ic(inputBase, fieldErrors.phone_no)}
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {[
                        {
                          label: "Date of Birth",
                          value: formatDate(p.patient_profile?.date_of_birth),
                        },
                        {
                          label: "Age",
                          value: calcAge(p.patient_profile?.date_of_birth),
                        },
                        {
                          label: "Gender",
                          value: p.patient_profile?.gender ?? "—",
                        },
                        {
                          label: "Language",
                          value: p.patient_profile?.preferred_language ?? "—",
                        },
                      ].map(({ label, value }) => (
                        <div
                          key={label}
